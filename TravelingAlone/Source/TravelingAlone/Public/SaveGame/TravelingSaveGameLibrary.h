...
struct FTravelingSaveGameBase
{
	GENERATED_BODY()
	//存档插槽Id
	UPROPERTY(VisibleAnywhere,DisplayName="存档插槽Id",Category="SaveGameSetting")
	FString SaveSlotId = FString(TEXT("SlotId"));
	//存档名称
	UPROPERTY(VisibleAnywhere,DisplayName="存档名称",Category="SaveGameSetting")
	FText SaveSlotName = FText::FromString(TEXT("未命名"));
	//存档时间
	UPROPERTY(VisibleAnywhere,DisplayName="存档时间",Category="SaveGameSetting")
	FTimespan SaveTime;
